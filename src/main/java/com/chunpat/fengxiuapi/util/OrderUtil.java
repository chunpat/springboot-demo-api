...
public class OrderUtil {
     ...
     * 随即编码
     */
    private static final String[] yearPrefix = new String[]{"A","B","C","D","E","F","G","H","I","J","K"};
    ...
    private static String getDateTime() {
        ...
        return OrderUtil.yearPrefix[Integer.parseInt(year.format(new Date())) - 2020] + sdf.format(new Date());
    }
